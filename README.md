<h1 align="center" color="#0000FF">crudJson</h1>
...
2. Clone the repository
   ...
   git clone https://github.com/keshavsoft/crudJson
   
   ```
3. Change Directory to crudGenByPath or Open the cloned folder, navigate to crudJson, and open the command prompt.
   ```
